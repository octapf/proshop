...
const ProductScreen = () => {
    ...
    const { loading: loadingRelated, error: errorRelated, products: relatedProducts } = productRelated
				...
				<>
                    ...
                    <Row className='mt-5'>
                        <Col>
                            ...
                            {loadingRelated ? <Loader /> : errorRelated ? <Message variant='danger'>{errorRelated}</Message> : (
                                <Row>
