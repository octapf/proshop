        ...
        <Card.Body>
          ...
          <Form onSubmit={submitHandler}>
            <Form.Group controlId="paymentMethod" className="mb-4">
              <Form.Label as="legend" className="mb-3 fw-bold">
                Select Method
              </Form.Label>
              <Col>
                <div className="payment-option mb-3">
                  ...
                  <label
                    htmlFor="PayPal"
                    className={`d-flex align-items-center p-3 border rounded-3 cursor-pointer ${paymentMethod === 'PayPal' ? 'border-primary bg-light' : ''}`}
